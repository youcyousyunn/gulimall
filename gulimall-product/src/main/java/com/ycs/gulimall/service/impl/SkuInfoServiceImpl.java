...
import com.ycs.gulimall.dao.SkuInfoDao;
...
import com.ycs.gulimall.vo.SeckillSkuVo;
...
//        }, executor);
        ...
        //等到所有任务都完成
        CompletableFuture.allOf(saleAttrFuture, descFuture, baseAttrFuture, imageFuture, null).get();
        return skuItemVo;
    }
}