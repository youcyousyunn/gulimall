...
--
-- Host: localhost    Database: gulimall_sms
-- ------------------------------------------------------
...
--
-- Table structure for table `sms_coupon_spu`
--
...
--
-- Dumping data for table `sms_coupon_spu`
--

LOCK TABLES `sms_coupon_spu` WRITE;
/*!40000 ALTER TABLE `sms_coupon_spu` DISABLE KEYS */;
/*!40000 ALTER TABLE `sms_coupon_spu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sms_coupon_spu_category`
--
...
--
-- Dumping data for table `sms_coupon_spu_category`
--

LOCK TABLES `sms_coupon_spu_category` WRITE;
/*!40000 ALTER TABLE `sms_coupon_spu_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `sms_coupon_spu_category` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `sms_seckill_sku`
--
...
--
-- Dumping data for table `sms_seckill_sku`
--

LOCK TABLES `sms_seckill_sku` WRITE;
/*!40000 ALTER TABLE `sms_seckill_sku` DISABLE KEYS */;
/*!40000 ALTER TABLE `sms_seckill_sku` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sms_sku_bounds`
--

LOCK TABLES `sms_sku_bounds` WRITE;
/*!40000 ALTER TABLE `sms_sku_bounds` DISABLE KEYS */;
INSERT INTO `sms_sku_bounds` VALUES (1,5,2000.0000,1000.0000,10),(2,6,1000.0000,2000.0000,9),(3,7,2000.0000,1000.0000,10),(4,8,1000.0000,2000.0000,9),(5,9,2000.0000,1000.0000,10),(6,10,1000.0000,2000.0000,9);
/*!40000 ALTER TABLE `sms_sku_bounds` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sms_sku_full_reduction` VALUES (1,5,5000.0000,100.0000,1),(2,6,6000.0000,1500.0000,1),(3,7,5000.0000,100.0000,1),(4,8,6000.0000,1500.0000,1),(5,9,5000.0000,100.0000,1),(6,10,6000.0000,1500.0000,1);
...
INSERT INTO `sms_sku_ladder` VALUES (1,5,2,9.00,NULL),(2,6,2,80.00,NULL),(3,7,2,9.00,NULL),(4,8,2,80.00,NULL),(5,9,2,9.00,NULL),(6,10,2,80.00,NULL);
...
-- Dump completed on 2020-11-10 11:32:01
